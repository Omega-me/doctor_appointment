 ...
 * @param opts
 */
export const prefetchAppointment = async <TData,>(opts: { queryClient: QueryClient; config?: IQueryOpts<TData> }) => {
  const route = eApiRoutes.APPOINTMENTS;
 ...
 * @returns
 */
export const useAppointmentQuery = <TData,>(opts?: IQueryOpts<TData>) => {
 ...
 * @param opts
 */
export const useAppointmentMutation = <TData,>(opts?: IMutationOpts<TData>) => {
  const queryClient = useQueryClient();
  const route = eApiRoutes.APPOINTMENTS;
